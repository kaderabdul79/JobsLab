    ...
    return (
        <Box>
            <Stack alignItems="center">
                ...
                <Typography textAlign="center" my={1} maxWidth="415px" variant='subtitle1'>Fill out our standardized application on our platform. Most applicants finish in under an hour.</Typography>
